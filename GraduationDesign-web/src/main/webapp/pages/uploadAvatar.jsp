...
<script type="text/javascript" src="<%=path%>/js/redjs/cloud-zoom.1.0.2.min.js"></script>
<script type="text/javascript" src="<%=path%>/js/redjs/uploadPreview.min.js"></script>
...
<body>
	<div class="inner_div">
	   ...
	   <div id="upA">
		<form action="uploadAvatar.do" method="post" id="form1" enctype="multipart/form-data">
			<input id="file"  type="file" name="userPhoto" /><!-- onchange="yulans()" -->
			<div id="imgdiv">
			<img id="img" style="width: 200px; height: 200px; border: 1px solid #999;" src="<%=path%>/images/redimg/sctx.jpg" alt="请先选择浏览图片才可预览"></div><br/><br/>
			<input style="width: 100px; height: 23px; " class="orange" type="button" onclick="$('#form1').submit();" value="上传头像"/>&nbsp;&nbsp;
