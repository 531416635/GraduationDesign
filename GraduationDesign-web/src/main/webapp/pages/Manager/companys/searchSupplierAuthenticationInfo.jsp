			...
			<ul class="paginList">
				<c:choose>
					...
					<c:otherwise>
						<li class="paginItem"><a
							href="/ssm/searthSupplierAuthenticationInfo.do?currentPage=${page.currentPage-1}&&companyName=${companyName}"><span
								class="pagepre"></span> </a></li>
					</c:otherwise>
				</c:choose>
				<c:forEach begin="1" end="${page.totalPage}" var="s3">
					<c:choose>
						...
						<c:otherwise>
							<li class="paginItem"><a
								href="/ssm/searthSupplierAuthenticationInfo.do?currentPage=${s3}&&companyName=${companyName}">${s3}</a>
							</li>
						</c:otherwise>
					</c:choose>
				</c:forEach>
