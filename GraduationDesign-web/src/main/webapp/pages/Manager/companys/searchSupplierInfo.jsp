...
<body>
    ...
    <div class="tools">
    	<ul class="toolbar">
        <li class=""><span><img src="images/t01.png" /></span><a href="/ssm/toAddSupplier.do">添加</a></li>
    ...
    <table class="tablelist">
        ...
        <td>
        <a class="tablelink" href="/ssm/toUpdateSupplier.do?id=${c.id}">修改</a>
       	<input type="button" value="删除" onclick="location.href='deleteSupplier.do?id=${c.id}';"/>
        </td>
        </tr> 
        </c:forEach>
        </tbody>
			...
			<ul class="paginList">
				<c:choose>
					...
					<c:otherwise>
						<li class="paginItem"><a
							href="/ssm/searthSupplierInfo.do?currentPage=${page.currentPage-1}&&companyName=${companyName}"><span
								class="pagepre"></span>
						</a>
						</li>
					</c:otherwise>
				...
				<c:forEach begin="1" end="${page.totalPage}" var="s3">
					<c:choose>
						...
						<c:otherwise>
							<li class="paginItem"><a
								href="/ssm/searthSupplierInfo.do?currentPage=${s3}&&companyName=${companyName}">${s3}</a>
							</li>
						</c:otherwise>
					</c:choose>
				</c:forEach>
