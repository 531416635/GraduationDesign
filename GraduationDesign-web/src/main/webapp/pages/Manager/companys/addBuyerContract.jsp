...
<body>
<div>
	<form action="addBuyerContract.do" enctype="multipart/form-data" method="post">
		<table>
			...
			<tr style="display: none">
 				<th>公司ID</th> 
				<td><input id="companyId" name="companyId" type="hidden" value="${companyId}"/>
				</td>
			</tr>
			...
			<tr>
				<th>合同期限:</th>
				<td><input name="contractExpirationTime" id="contractExpirationTime" 
				onclick="WdatePicker()" 
				readonly="readonly" />
				</td>
			</tr>
			<tr> 
				<th>合同类型:</th>
				<td>
					<input type="radio" name="contractType" value="0" onclick="showSupplyCategory(0)" /><span>采购商</span>
					<input type="radio" name="contractType" value="1" onclick="showSupplyCategory(1)"/><span>供应商</span>
				</td>
			</tr>
			...
			<tr>
				<th>合同内容:</th>
				<td colspan="3">
				<textarea cols="100" id="contractContent" style="width:90%; height: 300px;"
				name="contractContent"></textarea>
				</td>
			</tr>
		</table>
