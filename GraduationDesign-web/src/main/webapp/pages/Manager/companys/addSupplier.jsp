		...
		<form action="addSupplier.do" method="post">
			<table border="0" cellpadding="0" cellspacing="0">
				<tr style="display: none">
					<th>公司ID</th>
					<td><input readonly="readonly" name="id" value="${id}"
						required="required" /></td>
				</tr>
				<tr>
					<th>公司名称:</th>
					<td><input type="text" name="companyName"
						value="${companyName}" required="required" /></td>
				</tr>
				<tr>
					<th>公司地址:</th>
					<td><input type="text" name="companyAddress"
						value="${companyAddress}" required="required" /></td>
				</tr>
				<tr>
					<th>公司规模:</th>
					<td><input type="text" name="companyScale"
						value="${companyScale}" required="required" /></td>
				</tr>
				<tr>
					<th>注册资本:</th>
					<td><input name="registeredCapital" type="text"
						required="required" value="${registeredCapital}" /></td>
				</tr>
				<tr>
					<th>公司电话:</th>
				...
				<tr>
					<th>公司简介:</th>
					<td><input name="companyInfo" required="required"
						value="${companyInfo}" /></td>
				</tr>
				<tr>
					<th>销售人员:</th>
				...
				<tr>
					...
					<td><input type="text" name="companyContact"
						value="${companyContact}" required="required" /></td>
				</tr>
				<tr style="display: none">
					<th>公司类别</th>
					<td><input readonly="readonly" required="required"
						name="companyType" value="1" /></td>
				</tr>
			</table>
