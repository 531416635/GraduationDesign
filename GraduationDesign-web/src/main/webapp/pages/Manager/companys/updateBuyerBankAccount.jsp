...
<body>
<div>
	<form action="updateBuyerBankAccount.do" method="post">
		<table border="0" cellpadding="0" cellspacing="0">
			<tr style="display: none">
				<th>公司ID</th>
				<td><input name="companyId"  readonly="readonly" value="${cc.companyId}" />
				</td>
			</tr>
			<tr>
				<th>银行账号:</th>
				<td><input name="bankAccount"   value="${cc.bankAccount}" />
				</td>
			</tr>
			<tr>
				<th>开户行地址:</th>
				<td><input type="text" name="bankAddress" value="${cc.bankAddress}" />
				</td>
			</tr>
			<tr>
				<th>银行名称:</th>
			...
			<tr>
				...
				name="createTime" value="${cc.createTime}" />
				</td>
			</tr>
