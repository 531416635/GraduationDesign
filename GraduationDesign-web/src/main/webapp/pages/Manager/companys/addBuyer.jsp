...
<div>
	<form action="addBuyer.do" method="post">
		<table border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				<th>公司地址:</th>
				<td><input type="text" name="companyAddress" value="${companyAddress}" />
				</td>
			</tr>
			<tr>
				<th>公司规模:</th>
			...
			<tr>
				<th>邮政编码:</th>
				<td><input type="text" name="companyZipCode" value="${companyZipCode}" />
				</td>
			</tr>
			<tr>
				<th>公司简介:</th>
				<td><input name="companyInfo" value="${companyInfo}"/>
				</td>
			</tr>
			<tr style="display: none">
				<th>销售人员:</th>
			...
			<tr>
				<th>公司联系人:</th>
				<td><input type="text" name="companyContact" value="${companyContact}" />
				</td>
			</tr>
			<tr >
				<th>公司类别:</th>
				<td>
				<input type="radio" name="companyType" value="1" /><span>商户用户</span>
