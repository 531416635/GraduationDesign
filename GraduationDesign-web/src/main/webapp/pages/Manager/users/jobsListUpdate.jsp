...
<div>
	...
	<table border="0" cellpadding="0" cellspacing="0">
		...
		<tr class="info">
			<th>岗位名称:</th>
			<td><input type="text" name="jobName" value="${db.jobName}"  style="width:70px;"/></td>
		</tr>
		<!--  
		<tr class="info">
			<th>状态:</th>
		...
		<tr class="info">
			<th>创建人:</th>
			<td><input type="text" name="createBy" value="${db.createBy}"  style="width:70px;"/></td>
		</tr>
		<tr class="info">
			<th>创建时间:</th>
			<td><input type="text" name="createAt" value="${db.createAt}" onclick="WdatePicker()" style="width:70px;" readonly/></td>
		</tr>
	</table>
