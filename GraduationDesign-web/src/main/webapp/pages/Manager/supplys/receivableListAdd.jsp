...
<body>
	<div>
		<form action="receivableAdd.do" name="userForm" method="post">
			<input type="hidden" name="userId" id="userId" value="" />
			<table border="0" cellpadding="0" cellspacing="0">
				<tr class="info">
					<th>结算编号:</th>
					<td><input type="text" name="settlementId" required="required"
						style="width: 70px;" /></td>
				</tr>
				<tr class="info">
					<th>结算币种:</th>
				...
				<tr class="info">
					<th>结算金额:</th>
					<td><input type="text" name="settleAmount" required="required"
						style="width: 70px;" /></td>
				</tr>
				<tr class="info">
					<th>手续费:</th>
					<td><input type="text" name="settleFee" required="required" /></td>
				</tr>
				<tr class="info">
					<th>结算人:</th>
				...
				<tr class="info">
					<th>结算时间:</th>
					<td><input type="text" name="settleTime" required="required"
