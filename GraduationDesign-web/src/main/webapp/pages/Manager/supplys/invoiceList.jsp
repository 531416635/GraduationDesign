...
<body>
    ...
    <table class="tablelist">
        ...
        <c:forEach items="${invoices }" var="invoice">
	        <tr>
		        ...
		        <td><a href="toInvoiceUpdate.do?id=${invoice.id }" class="tablelink">修改</a>  <a href="invoiceDelete.do?id=${invoice.id }" class="tablelink"> 删除  </a></td>
	        </tr> 
        </c:forEach>
         </tbody>
    </table>
    ...
    <div class="pagin">
        ...
        <ul class="paginList">
        		<c:choose>
                		...
                		<c:otherwise>
                		 <li class="paginItem"><a href="/ssm/supplys/invoice.do?currentPage=${page.currentPage-1}"><span class="pagepre"></span></a></li>
                		</c:otherwise>
                </c:choose>
        		<c:forEach begin="1" end="${page.totalPage}" var="s3">
					 	<c:choose>
                    		...
                    		<c:otherwise>
                    		<li class="paginItem"><a href="/ssm/supplys/invoice.do?currentPage=${s3}">${s3}</a></li>
                    		</c:otherwise>
                    	</c:choose>
				</c:forEach>
				<c:choose>
                		...
                		<c:otherwise>
                		 <li class="paginItem"><a href="/ssm/supplys/invoice.do?currentPage=${page.currentPage+1}"><span class="pagenxt"></span></a></li>
                		</c:otherwise>
                </c:choose>    
        </ul>
    </div>
    ...
    <div class="tip">
      ...
      <div class="tipinfo">
        ...
        <div class="tipbtn">
        <input name="" type="button"  class="sure" value="确定" onclick="location='toInvoiceAdd.do'"/>&nbsp;
