	...
	<div class="rightinfo">
			...
			<tbody>
				<c:forEach items="${pays }" var="pay">
					<tr>
						...
						<td><a href="toPayableUpdate.do?id=${pay.id }"
							class="tablelink">修改</a> <a href="payableDelete.do?id=${pay.id }"
        ...
        <ul class="paginList">
        		<c:choose>
                		...
                		<c:otherwise>
                		 <li class="paginItem"><a href="/GraduationDesign/supplys/payable.do?currentPage=${page.currentPage-1}"><span class="pagepre"></span></a></li>
                		</c:otherwise>
                </c:choose>
        		<c:forEach begin="1" end="${page.totalPage}" var="s3">
					 	<c:choose>
                    		...
                    		<c:otherwise>
                    		<li class="paginItem"><a href="/GraduationDesign/supplys/payable.do?currentPage=${s3}">${s3}</a></li>
                    		</c:otherwise>
                    	</c:choose>
				</c:forEach>
				<c:choose>
                		...
                		<c:otherwise>
                		 <li class="paginItem"><a href="/GraduationDesign/supplys/payable.do?currentPage=${page.currentPage+1}"><span class="pagenxt"></span></a></li>
                		</c:otherwise>
                </c:choose>    
        </ul>
    </div> --%>
		...
		<div class="tip">
			...
			<div class="tipbtn">
				<input name="" type="button" class="sure" value="确定"
					onclick="location='toPayableAdd.do'" />&nbsp; <input name=""
