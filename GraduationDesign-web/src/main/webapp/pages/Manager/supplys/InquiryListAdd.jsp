...
<body onload='s3()'>
	<form action="/ssm/main/addInquiryList.do" name="userForm" method="post">
		...
		<%-- 	<tr class="info" style="display: none">
			...
			<tr class="info">
				<th>币种:</th>
				<td>
				<input type="radio" name="currency"  value="人民币"  checked="checked" /><span>人民币</span>
				<input type="radio" name="currency"  value="美元"/><span>美元</span>
				</td>
			</tr>
			<tr class="info">
				<th>交易方式:</th>
			...
			<tr class="info">
				<th>产品ID:</th>
				<td><input type="text"
					onkeyup="value=value.replace(/[^(\d)]/g,'')" name="productID"   required="required" />
				</td>
			</tr>
			<tr class="info">
				<th>产品数量:</th>
			...
			<tr class="info">
				<th>参考单价:</th>
				<td><input type="text"
					onkeyup="value=value.replace(/[^(\d)]/g,'')" name="refPrice"   required="required" />
				</td>
			</tr>
			<tr class="info">
				<th>期望单价:</th>
				<td><input type="text"
					onkeyup="value=value.replace(/[^(\d)]/g,'')" name="expectPrice"   required="required" />
				</td>
			</tr>
			<tr class="info">
				<th>期望交期:</th>
