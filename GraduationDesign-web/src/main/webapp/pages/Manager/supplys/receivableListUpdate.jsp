	...
	<div>
		<form action="receivableUpdate.do" name="userForm" method="post">
			...
			<table border="0" cellpadding="0" cellspacing="0">
				<tr class="info">
					...
					<td><input type="text" name="settlementId"
						value="${dbset.settlementId }" style="width: 70px;" /></td>
				</tr>
				<tr class="info">
					<th>结算币种:</th>
				...
				<tr class="info">
					...
					<td><input type="text" name="settleAmount"
						value="${dbset.settleAmount}" style="width: 70px;" /></td>
				</tr>
				<tr class="info">
					<th>手续费:</th>
					<td><input type="text" name="settleFee"
						value="${dbset.settleFee}" /></td>
				</tr>
				<tr class="info">
					<th>结算人:</th>
					<td><input type="text" name="settleBy"
						value="${dbset.settleBy}" /></td>
				</tr>
				<tr class="info">
					<th>结算时间:</th>
					<td><input type="text" name="settleTime"
						onclick="WdatePicker()" value="${dbset.settleTime}"
			...
			<input type="submit" value="提交" />&nbsp;<input type="button"
				value="取消" onclick="location='receivable.do'" />
		</form>
	</div>
</body>
</html>