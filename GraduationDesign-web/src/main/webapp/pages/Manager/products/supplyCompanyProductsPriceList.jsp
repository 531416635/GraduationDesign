...
<body>
    ...
    <div class="tools">
        ...
        <li><a class="tablelink" href="javaScript:addPrice();"><span><img src="../images/t01.png" /></span>添加</a></li>
        <li id="li1"><a class="tablelink" href="javaScript:historyInfo();">&nbsp;&nbsp;历史价格</a></li>
        <li id="li2"><a class="tablelink" href="javaScript:returnInfo();">&nbsp;&nbsp;返回</a></li>
        </ul>
    ...
    <table class="tablelist" id="tablelist1">
        ...
        <tr>
        <td><input type="checkbox" name="box" onclick="checkBox();" value="${c.id}@${c.grossMargins.id}"/></td>
        <td>${c.id}</td>
        <td>${c.minNum}</td>
        <td>${c.maxNum}</td>
        <td>${c.price}</td>
    ...
    <div id="addPrice" class="addPrice">
		...
		<tr>
			<th></th>
			<td><input type="hidden" readonly name="userId" value="${userInfo.id}"/></td>
		</tr>
		<tr>
			<th>最小数量:</th>
		...
		<tr >
			<th>到期时间:</th>
			<td><input type="text" name="endTime" onclick="WdatePicker()" readonly="readonly"/></td>
		</tr>
			</table>
			<input type="submit" value="增加" />
			<input type="reset" value="取消" onclick="resetAdd()"/>
		</form>
	</div>
