...
function checkDelete(id){
	 ...
	 if(r){
             location.href="/ssm/productType/deleteProductType.do?id="+id;
          }
}
...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li><a class="tablelink" href="/ssm/productType/toAddProductType.do"><span><img src="../images/t01.png" /></span>添加</a></li>
    ...
    <table class="tablelist">
        ...
        <td>${c.typeCode}</td>
        <td>
        <a class="tablelink" href="/ssm/productType/toUpdateProductType.do?id=${c.id}">修改</a>
   ...
   <%-- <div class="pagin">
        ...
        <ul class="paginList">
        		<c:choose>
                		...
                		<c:otherwise>
                		 <li class="paginItem"><a href="/ssm/productType/productTypeList.do?currentPage=${page.currentPage-1}"><span class="pagepre"></span></a></li>
                		</c:otherwise>
                </c:choose>
        		<c:forEach begin="1" end="${page.totalPage}" var="s3">
					 	<c:choose>
                    		...
                    		<c:otherwise>
                    		<li class="paginItem"><a href="/ssm/productType/productTypeList.do?currentPage=${s3}">${s3}</a></li>
                    		</c:otherwise>
                    	</c:choose>
				</c:forEach>
				<c:choose>
                		...
                		<c:otherwise>
                		 <li class="paginItem"><a href="/ssm/productType/productTypeList.do?currentPage=${page.currentPage+1}"><span class="pagenxt"></span></a></li>
                		</c:otherwise>
                </c:choose>    
        </ul>
    </div> --%>
