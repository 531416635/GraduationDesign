 ...
 function getText(){
            ...
            xhr.onreadystatechange=function(){
                if(xhr.readyState==4 && xhr.status==200){
                    window.location.href="historicalPriceList.do";
                }
            };
...
<body >
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li><a class="tablelink" href="/ssm/historicalPrice/toAddHistoricalPrice.do"><span><img src="../images/t01.png" /></span>添加</a></li>
    ...
    <table class="tablelist">
       ...
       <!--  <th>商品类别</th> -->
        ...
        <td>${c.id}</td>
        <td>${c.productName}</td>
        <td><%-- ${c.productTypee.typeName} --%>
        <%-- <c:forEach items="${c.productTypes}" var="m" varStatus="s">
                            		<c:choose>
                            			<c:when test="${s.last}">
                            				${m.typeName}
                            			</c:when>
      ...
      <%--   <td>${c.commodityBrand}</td> --%>
       ...
       <%--  <td>${c.producingArea}</td> --%>
        ...
        <td>
        <a class="tablelink" href="/ssm/historicalPrice/toHistoricalPriceInfo.do?id=${c.id}">历史详情</a>
        <a class="tablelink" href="/ssm/products/toUpdateProduct.do?id=${c.id}">修改</a>
