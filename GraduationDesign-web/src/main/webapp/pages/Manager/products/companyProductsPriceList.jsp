...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li><a class="tablelink" href="/ssm/companyProducts/toCompanyProductPriceAdd.do?companyProductId=${companyProductId}"><span><img src="../images/t01.png" /></span>添加</a></li>
    ...
    <table class="tablelist">
        ...
        <td>
        <a class="tablelink" href="/ssm/companyProducts/toCompanyProductPriceUpdate.do?id=${c.id}">修改</a>
