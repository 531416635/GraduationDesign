 ...
 function getText(){
            ...
            xhr.onreadystatechange=function(){
                if(xhr.readyState==4 && xhr.status==200){
                    window.location.href="grossMarginPriceList.do";
                }
            };
...
<body >
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li><a class="tablelink" href="/ssm/grossMarginPrice/toAddGrossMarginPrice.do"><span><img src="../images/t01.png" /></span>添加</a></li>
    ...
    <table class="tablelist">
        ...
        <td>
        <a class="tablelink" href="/ssm/grossMarginPrice/toGrossProductInfo.do?id=${c.id}">商品详情</a>
        <a class="tablelink" href="/ssm/grossMarginPrice/toUpdategrossMarginPrice.do?id=${c.id}">修改</a>
