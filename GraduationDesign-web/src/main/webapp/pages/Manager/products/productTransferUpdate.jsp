	...
	<div>
		<form action="productTransferUpdate.do" name="userForm" method="post">
			<input type="hidden" name="companyProductId"
				value="${productTransfer.companyProductId}" /> <input type="hidden"
				name="id" value="${productTransfer.id}" />
			<table border="0" cellpadding="0" cellspacing="0">
				<tr class="info">
					<th>中转地:</th>
					<td><input type="text" name="transitShipment"
						value="${productTransfer.transitShipment}" /></td>
				</tr>
				<tr class="info">
					<th>联系人:</th>
					<td><input type="text" name="linkMan"
						value="${productTransfer.linkMan}" /></td>
				</tr>
				<tr class="info">
					<th>联系电话:</th>
					<td><input type="text" name="linkTel"
						value="${productTransfer.linkTel}" /></td>
				</tr>
				<tr class="info">
					<th>到达时间:</th>
					<td><input type="text" name="arrivalTime"
						value="${productTransfer.arrivalTime}" /></td>
				</tr>
				<tr class="info">
					<th>批次:</th>
					<td><input type="text" name="batch"
						value="${productTransfer.batch}" /></td>
				</tr>
			</table>
