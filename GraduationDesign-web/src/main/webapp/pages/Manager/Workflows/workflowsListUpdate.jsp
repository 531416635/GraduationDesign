...
<body>
	...
	<table border="0" cellpadding="0" cellspacing="0">
			<tr class="info">
				<th>流程类型ID:</th>
				<td><input type="text" name="workflowTypeId" value="${workflows.workflowTypeId}"
					onkeyup="value=value.replace(/[^(\d)]/g,'')" /></td>
			</tr>
			<tr class="info">
				<th>节点ID:</th>
				<td><input type="text" name="nodeId" value="${workflows.nodeId}"
					onkeyup="value=value.replace(/[^(\d)]/g,'')" /></td>
			</tr>
			<tr class="info">
				<th>用户ID:</th>
				<td><input type="text" name="userId" value="${workflows.userId}"
