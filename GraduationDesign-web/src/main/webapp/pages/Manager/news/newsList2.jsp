...
function  getXhr(){
 ...
 function getText(){
           ...
           xhr.open("post","deleteMoreNotice.do",true);
...
function checkDelete(id){
	 ...
	 if(r){
             location.href="/GraduationDesign/news/deleteNotice.do?id="+id;
          }
}
...
$(function(){
	...
	function pageselectCallback(page_index, jq){  //此函数为分页动态按钮展现的回调函数，即分页展现商品
		if(flag){
		location.href="noticeList.do?currentPage="+(page_index+1);
		}
		flag=true;
		return false;	
	   }
		...
		<div class="tools">
			...
			<ul class="toolbar">
				<li><a class="tablelink"
					href="/GraduationDesign/news/toAddNotice.do?newType=2"><span><img
				...
				<c:forEach items="${news}" var="c">
					<tr>
						...
						<td><a class="tablelink"
							href="/GraduationDesign/news/toUpdateNotice.do?id=${c.id}">修改</a> <a
