...
<body>
	<div class="top">
         <form id="form" action="<%=path%>/weChat/findOfferInquiry.do" method="post">
         	<P><span>报价单号：</span><input type="text" name="priceSheetId"/></P>
            <P><span>商品名称：</span><input type="text" name="productName"/></P>
            <P><span>报价日期：</span>
            <input style="width:35%" type="text" name="createDateStart" onclick="WdatePicker()" readonly="readonly"/>-<input style="width:35%" type="text" name="createDateStop" onclick="WdatePicker()" readonly="readonly"/></P>
         ...
         <table>
            ...
            <tr>
            	<td>日期：</td>
                <td>
                <fmt:formatDate value="${it.CreateDate}" type="both" pattern="yyyy-MM-dd"/>
                </td>
            </tr>
            <tr>
            	<td>状态：</td>
