...
<div id="div_body" class="login-top">
	<div style="height:320px; padding-top:20px;">
		...
		<div class="div_input">
			<span><img src="<%=path %>/images/WeChat/denlv.png"/></span>
			<input   id="name" type="text" name="userCode"  placeholder="&nbsp;用户名:">
		</div>
		<div class="div_input">
			<span><img src="<%=path %>/images/WeChat/mima.png"/></span>
			<input  id="pwd" type="password" name="userPsw"  placeholder="&nbsp;密码:" >
		</div>
			<input style="width:100%; height:40px; font-size:180%" type="button" value="登 录" onclick="check_login();"  >
	    </form>
	    <div class="forgot">
	    	<p>没有一起采账号<a href="/ssm/web/toReg.do">点击这里进行注册</a><a style="float:right" id="pw" href="/ssm/web/toWjmm.do">忘记密码</a></p>
	    </div>
	</div>
</div>	
</body>
