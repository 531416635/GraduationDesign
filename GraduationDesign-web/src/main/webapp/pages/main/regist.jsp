...
<div>
	...
	<table border="0" cellpadding="0" cellspacing="0">
		<tr class="info">
			...
			<td>
			  <input type="radio" name="user" value="0"/><span>采购商</span>
			  <input type="radio" name="user" value="1"/><span>供应商</span>
			</td>
		</tr>
		<tr class="info">
		...
		<tr class="info">
			...
			<td>
			  <input type="text" name="createBy" style="width:60px;"/>
			  <input type="radio" name="who" value="0" checked/><span>先生</span>
			  <input type="radio" name="who" value="1"/><span>女士</span>
			</td>
		</tr>
		<tr class="info">
		...
		<tr class="info">
			...
			<td>
			 ...
			 <span>我已阅读并接受<a href="javacript:;">&lt;&lt;团掌网用户协议&gt;&gt;</a>及<a href="javacript:;">&lt;&lt;隐私策略&gt;&gt;</a></span>
			</td>
		</tr>
	</table>
