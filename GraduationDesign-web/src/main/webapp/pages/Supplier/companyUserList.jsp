...
function checkDelete(id){
	 ...
	 if(r){
             location.href="/ssm/users/deleteCompanyUsers.do?id="+id;
          }
}
...
<body >
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li><a class="tablelink" href="/ssm/users/toCompanyAddUsers.do"><span><img src="../images/t01.png" /></span>添加</a></li>
    ...
    <table class="tablelist">
        ...
        <td><input type="checkbox" name="box" onclick="checkBox();" value="${userManager.id}" /></td>
         <td>${userManager.id}</td>
		        ...
		        <td><a href="toUserManagerAll2.do?id=${userManager.id }"  class="tablelink">详细信息</a> <a href="toUserManagerUpdate2.do?id=${userManager.id }" class="tablelink">修改</a>  <a href="javascript:checkDelete(${userManager.id});" class="tablelink"> 删除  </a>
		        </td>
		            </tr> 
		             </c:if> 
        </c:forEach>
