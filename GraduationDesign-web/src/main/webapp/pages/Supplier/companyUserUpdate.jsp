          ...
          $.ajax({
             ...
             success: function(data,textStatus){
             	//提示
                		...
                		location.href="toCompanyUserLists.do";
                      }
                });
	  }	
</script>
...
<body>
	<div id="div1">
		<form id="form" action="userManagerUpdate2.do" name="userForm"
			method="post">
			<input type="hidden" name="id" id="id" value="${db.id}" /> <input
				type="hidden" name="roleId" id="roleId" value="${userInfo.roleId}" />
			<input type="hidden" name="userType" id="userType"
				value="${userInfo.userType}" /> <input type="hidden"
				name="companyId" id="companyId" value="${userInfo.companyId}" /> <input
				type="hidden" name="regTime" id="regTime" value="${db.regTime}" />
			<table border="0" cellpadding="0" cellspacing="0">
				...
				<tr class="info">
					...
					<td><input type="text" name="userUnits"
						value="${db.userUnits}" style="width: 180px;" /></td>
				</tr>
				<tr class="info">
					<th>Email:</th>
		...
		<tr class="info">
			...
			<input type="button" value="提交" onclick="update();" /> <input
