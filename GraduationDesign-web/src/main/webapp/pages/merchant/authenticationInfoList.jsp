				...
				<div id="tab3">
							...
							<c:forEach items="${authenticationManagers}" var="c">
								<tr>
									...
									<td style="display: none"><input type="hidden"
										id="renz${c.id}" value="${c.filePath}" /><a href="#"
										onclick="zhanshi(${c.id})">${c.filePath}</a></td>
									<td align="center"><img src="<%=path%>${c.filePath}"
										style="width: 240px; height: 300px;" /></td>
									...
									<c:if test="${c.status!=1}">
										<td align="center" class="t2"><a
											href="deleteAuthenticationInfo.do?id=${c.id}&&show=3">删除</a></td>
									</c:if>
								</tr>
							</c:forEach>
						</tbody>
					...
					<c:if test="${authenticationManagers[4].status!=1}">
						<select name="authenticationName" id="authenticationName">
							<option value="组织机构代码证" id="t1"><span
									style="color: red;">*&nbsp;</span>组织机构代码证
							</option>
							<option value="经营许可证" id="t2"><span style="color: red;">*&nbsp;</span>经营许可证
							</option>
							<option value="委托证明" id="t3"><span style="color: red;">*&nbsp;</span>委托证明
							</option>
							<option value="企业税务登记证" id="t4"><span
									style="color: red;">*&nbsp;</span>企业税务登记证
							</option>
							<option value="主要经营者身份证正反复印件" id="t5"><span
									style="color: red;">*&nbsp;</span>主要经营者身份证正反复印件
							</option>
						</select>&nbsp;&nbsp;&nbsp;
						<input type="file" id="imgFile" name="file" />&nbsp;&nbsp;&nbsp;
					<input class="input_but orange" type="button" value="上传"
							onclick="renzheng()" id="btn" />
