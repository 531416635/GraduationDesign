...
<body>
	...
	<div class="inner_div">
		<%-- <div class="divHead"><jsp:useBean id="now"
				class="java.util.Date"></jsp:useBean>
			<img src="" style="height:30px;width:30px;padding:10px;" /><span>当前位置：</span>
			<span>商品管理</span><span style="margin-left:500px;"><fmt:formatDate
					value="${now}" pattern="yyyy年MM月dd日  E" />
			</span>
		</div>
		<div class="location">
			<hr style="color: red;border: 1px solid;" />
			<div
				style="border:2px solid #F5F5F5;border-top:0px;height:25px;padding:10px;">
				<span style="font-size:18px;"><b>商品收藏</b>
				</span><br />
			</div>
		</div> --%>
		<div
