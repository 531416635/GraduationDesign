...
<body>
	...
	<div class="inner_div">
		<div style="height:45px; line-height:45px; border-bottom:1px solid #D1D1D1; font-size:14px; padding-left:15px;">
			...
			<form action="<%=path%>/merchant/addBankAccount.do" method="post" id="form">
			<table>
				<tr style="display: none">
				<td>ID<input  name="id" /></td>
				</tr>
				<tr style="display: none">
				<td colspan="3">companyId<input class="input_text" name="companyId" value="${companyId}"></td>
				</tr>
				<tr>
				<td style="width: 5px;"><span style="color: red;">*</span></td>
				<td>银行账号：</td>
				<td><input  class="input_text"  type="text" name="bankAccount" id="bankAccount"/></td>
				</tr>
				<tr>
				<td></td>
				<td>银行地址：</td>
			...
			<input style="width: 70px; height: 23px; margin-left: 30px;" class="orange" type="button" value="提交" onclick="check();"/>
			</form>
