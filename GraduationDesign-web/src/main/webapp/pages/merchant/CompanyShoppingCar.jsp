...
<body>
	...
	<div class="inner_div">
		<div
			...
			<span class="lo1">首页</span> > <span class="lo2"></span> 商品管理 > <span
				class="lo2">部门购物车</span>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<table width="100%" border="1" cellspacing="0" align="center">
				...
				<tbody>
					...
					<c:forEach items="${list}" var="c">
						<tr>
							<td><input type="checkbox" name="shoppingIds"
								id="shoppingIds"
								value="${c.ProductID}|${c.sumNum}|${c.address}|${c.CompanyID}|${c.DepartmentID}|${c.ProductID}" /></td>
							<td>${c.DepartmentName}</td>
							<td><img src="<%=path%>${c.FilePath}"
								style="height: 50px; width: 30px;"></td>
							...
							<td><input type="button" value="查看详情"
								onclick="showShoppingCart(${c.CompanyID},${c.DepartmentID},${c.ProductID},'${c.address}')"></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
