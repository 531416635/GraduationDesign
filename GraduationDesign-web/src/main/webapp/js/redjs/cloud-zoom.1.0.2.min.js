	...
	function CloudZoom(g, i) {
				...
				function() {
					if (n === null) {
						...
						g
								...
								.append(
										format(
												'<div style="width:%0px;position:absolute;top:75%;left:%1px;text-align:center" class="cloud-zoom-loading" ></div>',
												/*这个div里显示的是图片前的提示语！*/
												w / 3, (w / 2) - (w / 6)))
		...
		this.init = function() {
			...
			n = g
					...
					.append(
							format(
									"<div class='mousetrap' style='background-image:url(\".\");z-index:-1;position:absolute;width:%0px;height:%1px;left:%2px;top:%3px;\'></div>",
					...
					.bind(
							...
							function(a) {
								...
								m = e
										.append(
												format(
														'<div id="cloud-zoom-big" class="cloud-zoom-big" style="display:none;position:absolute;left:%0px;top:%1px;width:%2px;height:%3px;background-image:url(\'%4\');z-index:-1;"></div>',
														b, yPos, w, h, s.src))
										.find(':last');
