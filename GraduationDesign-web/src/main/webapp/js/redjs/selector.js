...
function getStockOpt(id,name){
	...
	$("#addressjoin").val(""+currentAreaInfo.currentProvinceId+","+currentAreaInfo.currentCityId+","+currentAreaInfo.currentAreaId);
}
...
function CurrentAreaInfoInit(){
	...
	if(provinceId!=null&&provinceId!=""){
		currentAreaInfo =  {"currentLevel": 1,"currentProvinceId": provinceId,"currentProvinceName":provinceName,"currentCityId": cityId,"currentCityName":cityName,"currentAreaId": areaId,"currentAreaName":areaName};
	}else{
